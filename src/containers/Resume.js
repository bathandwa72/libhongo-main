          ...
          <div className="row">
            <div className="col-xs-12">
              ...
              <p>
                ...
                Accounting, Corporate Governance, Taxation, Economics, Corporate
                Financial Management, Busienss Statistics, Computational
                Mathematics, Management &amp; Information Systems.
              </p>
            </div>
            <div className="col-xs-12">
